...
###Função dos Frames da Tela Principal
    def frames_tela(self):
        self.frame1 = Frame(self.root, bd=4 ,bg="#B0C4DE", highlightbackground="#4682B4", highlightthickness=3 )
        self.frame1.place(relx= 0.02 ,rely=0.02, relwidth=0.96, relheight=0.40 )       
        self.frame2 = Frame(self.root,bd=4 ,bg="#B0C4DE", highlightbackground="#4682B4", highlightthickness=3 )
...
###Funções dos Labels e Imputs Frame_1
    def form_frame1(self):
        ...
        self.en_matricula.place(relx= 0.02 ,rely=0.1, relwidth=0.1, relheight=0.1 ) 
        #Label e imput Nome
        #Label
        ...
        self.en_montadora.place(relx= 0.02 ,rely=0.70, relwidth=0.23, relheight=0.1 ) 
        ...
        self.en_modelo.place(relx= 0.26 ,rely=0.70, relwidth=0.24, relheight=0.1 ) 
        #Label e imput Montadora
        #Label
...
###Botões do Frame_1,  formulario   
    def buttons_form_frame_1(self):
        ...
        def salvar() -> NONE:
            msg.showinfo("Novo Cadastro","Cadastro Realizado com sucesso com sucesso")

        def excluir() -> NONE:
            msg.showinfo("Excluir Cadastro","Cadastro Ecluido com sucesso com sucesso")
        ### Botão limpar
        self.bt_limpar = Button(self.frame1, text="Limpar", font=('verdana',8,'bold') )
        self.bt_limpar.place(relx=0.14, rely=0.1, relwidth=0.1, relheight=0.1)
        ### Botão Buscar
        self.bt_buscar = Button(self.frame1, text="Buscar",font=('verdana',8,'bold'))
        self.bt_buscar.place(relx=0.25, rely=0.1, relwidth=0.1, relheight=0.1)
        ### Botão Novo
        self.bt_novo = Button(self.frame1, text="Novo", command=salvar,font=('verdana',8,'bold'))
        self.bt_novo.place(relx=0.66, rely=0.1, relwidth=0.1, relheight=0.1)
        ### Botão Editar
        self.bt_edit = Button(self.frame1, text="Editar",font=('verdana',8,'bold'))
        self.bt_edit.place(relx=0.77, rely=0.1, relwidth=0.1, relheight=0.1)
        ### Botão Apagar
        self.bt_delet = Button(self.frame1, text="Excluir", command=excluir,font=('verdana',8,'bold'))
        self.bt_delet.place(relx=0.88, rely=0.1, relwidth=0.1, relheight=0.1)

###Lista cadastrados frame 2
    def lista_frame2(self):
        self.listaCli = ttk.Treeview(self.frame2, height=3, columns=("col0","col1","col2","col3","col4"))
        ...
        #self.scrollList = Scrollbar(self.lista_frame2)        
        #self.scrollList.place(relx=0.94, rely=0.1, relwidth=0.02, relheight=0.85)
